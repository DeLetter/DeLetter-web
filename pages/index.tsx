  ...
  return (
    <div className='flex flex-col justify-center items-center h-full'>
      ...
      <div className='flex flex-col justify-center w-[60%] z-10'>
        ...
        <Link href='/management' className='p-2 mt-[14px] border-2 border-black rounded-md hover:bg-[#000000] hover:text-[#ffffff] text-center transition duration-300'>Start manage </Link>
      </div>
    </div>
  )
}
